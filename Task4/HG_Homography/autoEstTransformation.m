...
% 
% [tform, inlierIdx] = estimateGeometricTransform2D(matchedPoints1, matchedPoints2, 'affine', 'MaxNumTrials', 2500);
% 
...
figure
showMatchedFeatures(img2, img2, transformPointsForward(tform, matchedPoints1.Location), matchedPoints2.Location)